import type { ConceptGraph, Question, QuestionKind } from '../engine/types';

export const DEMO_TEXT = `Database Management Systems (DEMO syllabus)
Unit 1: Relational Foundations
- Relational Model
- Keys and Constraints
Unit 2: Querying and Design
- SQL Joins
- Normalization
Unit 3: Transactions
...
export const DEMO_GRAPH: ConceptGraph = {
  id: 'demo-dbms',
  title: 'Database Management Systems',
  source: 'demo',
  nodes: [
    { id: 'relmodel', label: 'Relational Model', unit: 'Relational Foundations', description: 'Relations, tuples, attributes, schemas.' },
    { id: 'keys', label: 'Keys & Constraints', unit: 'Relational Foundations', description: 'Primary, candidate, foreign keys and integrity.' },
    { id: 'joins', label: 'SQL Joins', unit: 'Querying and Design', description: 'Inner, outer and cross joins.' },
    { id: 'norm', label: 'Normalization', unit: 'Querying and Design', description: 'Functional dependencies, 1NF-BCNF.' },
    { id: 'acid', label: 'Transactions & ACID', unit: 'Transactions', description: 'Atomicity, consistency, isolation, durability.' },
    { id: 'cc', label: 'Concurrency Control', unit: 'Transactions', description: 'Locking, 2PL, deadlocks, isolation levels.' },
    { id: 'index', label: 'Indexing', unit: 'Performance', description: 'B-trees, hash indexes, clustering.' },
    { id: 'qopt', label: 'Query Optimization', unit: 'Performance', description: 'Cost-based plans, join ordering.' },
  ],
  edges: [
    { from: 'relmodel', to: 'keys', weight: 0.9 },
    { from: 'keys', to: 'joins', weight: 0.8 },
    { from: 'keys', to: 'norm', weight: 0.7 },
    { from: 'relmodel', to: 'joins', weight: 0.5 },
    { from: 'relmodel', to: 'acid', weight: 0.4 },
    { from: 'acid', to: 'cc', weight: 0.9 },
    { from: 'keys', to: 'index', weight: 0.6 },
    { from: 'index', to: 'qopt', weight: 0.8 },
    { from: 'joins', to: 'qopt', weight: 0.7 },
    { from: 'cc', to: 'qopt', weight: 0.2 },
  ],
};
...
/** The one rehearsed trigger: answering this contrast question wrong while Solid forces a REOPEN. */
export const DEMO_REOPEN_TRIGGER = {
  nodeId: 'keys',
  hint: 'Get two Keys diagnostics right, then miss the Keys contrast question (answer: both id and email are candidate keys).',
};
